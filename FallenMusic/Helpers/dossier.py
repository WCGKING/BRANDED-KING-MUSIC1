...
from FallenMusic import SUDOERS, _boot_
from Fallen.plugins.playlist import del_plist_msg
from Fallenplugins.sudoers import sudoers_list
from Fallen.utils.database import (add_served_chat,
                                       add_served_user,
                                       get_served_chats,
                                       get_served_users,
                                       blacklisted_chats,
...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgUAAxkBAAEPNt9k_YLPNQs7oi-pDFocyvvzJwptCgAChwQAAliZwVeKDtt3P3IjBDAE")
